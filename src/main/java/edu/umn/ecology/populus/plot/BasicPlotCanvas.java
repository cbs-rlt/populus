...
import edu.umn.ecology.populus.visual.HTMLConstants;
    ...
    private void jbInit() throws Exception {
      ...
      if( info != null ) {
        ...
        if (PopPreferencesStorage.isUseJFreeClass()) {
            ...
            chart.setTrigger(0, new EventTrigger(InputEvent.SHIFT_DOWN_MASK, EventTrigger.CUSTOMIZE));
            chart.setTrigger(1, new EventTrigger(InputEvent.BUTTON1_DOWN_MASK, EventTrigger.ZOOM));
            chart.setResetKey('r');
