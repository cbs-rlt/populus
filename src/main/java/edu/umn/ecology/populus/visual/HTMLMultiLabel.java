...
public class HTMLMultiLabel extends JPanel implements HTMLConstants {
    ...
    public void setDirection(int newDirection) {
        ...
        for (HTMLLabel label : labels) label.setDirection(newDirection);
        setText(text);
    }

    public void setDefaultFont(Font newDefaultFont) {
        for (HTMLLabel label : labels) label.setDefaultFont(newDefaultFont);
    }

    public void setDefaultColor(Color c) {
        for (HTMLLabel label : labels) label.setDefaultColor(c);
    }
