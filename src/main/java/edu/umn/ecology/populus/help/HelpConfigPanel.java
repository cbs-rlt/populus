...
public class HelpConfigPanel extends JPanel {
    ...
    public HelpConfigPanel() {
        ...
        filePathField.addActionListener(e -> filenameChanged());
        ...
        btnCopyHelpTo.addActionListener(e -> copyHelpFileOut(true));
        ...
        rdbtnDesktopApi.addChangeListener(arg0 -> openMethodChanged());
        ...
        rdbtnJnlpApi.addChangeListener(arg0 -> openMethodChanged());
        ...
        rdbtnCustomCommand.addChangeListener(arg0 -> openMethodChanged());
