...
public class AIDSBASICPanel extends BasicPlotInputPanel {
    ...
    final StyledRadioButton xvsyvsvButton = new StyledRadioButton();
    ...
    final PopulusParameterField paramU = new PopulusParameterField();
    ...
    final PopulusParameterField paramV = new PopulusParameterField();
