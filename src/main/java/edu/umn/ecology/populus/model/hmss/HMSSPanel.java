...
public class HMSSPanel extends BasicPlotInputPanel {
    ...
    final PopulusParameterField bPPF = new PopulusParameterField();
    private final JPanel plotTypeP = new JPanel();
    private final JRadioButton rqDBCRB = new StyledRadioButton();
    private final JRadioButton pqDABRB = new StyledRadioButton();
    private final PopulusParameterField ePPF = new PopulusParameterField();
    ...
    private final JRadioButton VvstRB = new StyledRadioButton();
    private final JRadioButton DvstRB = new StyledRadioButton();
    private final PopulusParameterField p0PPF = new PopulusParameterField();
    private final PopulusParameterField r0PPF = new PopulusParameterField();
    private final PopulusParameterField gensPPF = new PopulusParameterField();
    private final PopulusParameterField q0PPF = new PopulusParameterField();
    private final PopulusParameterField aPPF = new PopulusParameterField();
    private final JRadioButton pqrvstRB = new StyledRadioButton();
    private final JPanel modelTypeP = new JPanel();
    private final JRadioButton monoRB = new JRadioButton();
    private final JRadioButton polyRB = new JRadioButton();
    private final JRadioButton andersonRB = new JRadioButton();
    private final JRadioButton bellRB = new JRadioButton();
    private final GridBagLayout gridBagLayout2 = new GridBagLayout();
    private final ButtonGroup baBG = new ButtonGroup();
    private final ButtonGroup mpBG = new ButtonGroup();
