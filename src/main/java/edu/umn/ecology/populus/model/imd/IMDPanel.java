...
public class IMDPanel extends BasicPlotInputPanel {
    ...
    final StyledRadioButton phaseButton = new StyledRadioButton();
    Border border9;
    final StyledRadioButton ivsnButton = new StyledRadioButton();
    ...
    final JRadioButton siFDModelButton = new JRadioButton();
    final JPanel hostRatesPanel = new JPanel();
    final JRadioButton siDDModelButton = new JRadioButton();
    final PopulusParameterField paramBirth = new PopulusParameterField();
    final GridBagLayout gridBagLayout5 = new GridBagLayout();
    final PopulusParameterField paramDeath = new PopulusParameterField();
    final GridBagLayout gridBagLayout1 = new GridBagLayout();
    final PopulusParameterField paramnu = new PopulusParameterField();
    final PopulusParameterField paramgamma = new PopulusParameterField();
