...
public class RCPanel extends BasicPlotInputPanel {
    ...
    private final JRadioButton phivsr1Button = new StyledRadioButton();
    private final JRadioButton n2vsn1Button = new StyledRadioButton();
    private final GridBagLayout gridBagLayout12 = new GridBagLayout();
    private final JRadioButton c2r2Button = new JRadioButton();
    private final JPanel resourceTypePanel = new JPanel();
    private final JRadioButton c2r1Button = new JRadioButton();
    final GridBagLayout gridBagLayout13 = new GridBagLayout();
    final JRadioButton seasonalModelButton = new JRadioButton();
    final JPanel modelTypePanel = new JPanel();
    final JRadioButton equableModelButton = new JRadioButton();
    final JRadioButton c1r1Button = new JRadioButton();
    private final JRadioButton phivsr2Button = new StyledRadioButton();
    private final JRadioButton rvstButton = new StyledRadioButton();
    private final JRadioButton nvstButton = new StyledRadioButton();
    private final JRadioButton nandrvstButton = new StyledRadioButton();
    private final PopulusParameterField paramb12 = new PopulusParameterField();
    private final PopulusParameterField parame22 = new PopulusParameterField();
    private final GridBagLayout gridBagLayout3 = new GridBagLayout();
    private final PopulusParameterField paramb11 = new PopulusParameterField();
    private final PopulusParameterField parame21 = new PopulusParameterField();
    private final PopulusParameterField paramb22 = new PopulusParameterField();
    private final PopulusParameterField paramC2 = new PopulusParameterField();
    private final PopulusParameterField paramb21 = new PopulusParameterField();
    private final PopulusParameterField paramC1 = new PopulusParameterField();
    private final PopulusParameterField paramW = new PopulusParameterField();
    private final PopulusParameterField paramV = new PopulusParameterField();
    private final PopulusParameterField parama12 = new PopulusParameterField();
    private final PopulusParameterField parama11 = new PopulusParameterField();
    private final PopulusParameterField parame12 = new PopulusParameterField();
    private final PopulusParameterField parame11 = new PopulusParameterField();
    private final JPanel hostRatesPanel = new JPanel();
    private final PopulusParameterField parama22 = new PopulusParameterField();
    private final PopulusParameterField paramD = new PopulusParameterField();
    private final PopulusParameterField parama21 = new PopulusParameterField();
    private final PopulusParameterField paramn2 = new PopulusParameterField();
    private final PopulusParameterField paramn1 = new PopulusParameterField();
    private final GridBagLayout gridBagLayout2 = new GridBagLayout();
    private final JPanel initialDensitiesPanel = new JPanel();
    ...
    private void jbInit() throws Exception {
        ...
        c2r2Button.addActionListener(this::modelChangedActionPerformed);
        ...
        c2r1Button.addActionListener(this::modelChangedActionPerformed);
        ...
        seasonalModelButton.addActionListener(this::modelChangedActionPerformed);
        ...
        equableModelButton.addActionListener(this::modelChangedActionPerformed);
        c1r1Button.setFocusPainted(false);
        c1r1Button.setText("1 consumer/ 1 resource");
        c1r1Button.addActionListener(this::modelChangedActionPerformed);
