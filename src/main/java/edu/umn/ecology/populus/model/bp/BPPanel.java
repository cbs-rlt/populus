...
public class BPPanel extends BasicPlotInputPanel {
    ...
    final PopulusParameterField paramnp = new PopulusParameterField();
    TitledBorder titledBorder6;
    final PopulusParameterField paramnstar = new PopulusParameterField();
    TitledBorder titledBorder7;
    final JPanel initialDensitiesPanel = new JPanel();
    Border border3;
    ...
    private final PopulusParameterField paramTI = new PopulusParameterField();
    private final PopulusParameterField paramD = new PopulusParameterField();
    private final PopulusParameterField paramalpha = new PopulusParameterField();
    private final PopulusParameterField paramGamma = new PopulusParameterField();
    private final JRadioButton nstarvsnButton = new StyledRadioButton();
    private final JRadioButton fvstButton = new StyledRadioButton();
    private final JRadioButton npvsnButton = new StyledRadioButton();
    private final JPanel plasmidPanel = new JPanel();
    ...
    private final PopulusParameterField parame = new PopulusParameterField();
    private final GridBagLayout gridBagLayout4 = new GridBagLayout();
    private final JRadioButton variabletaugammaButton = new JRadioButton();
    private final JRadioButton constantaugammaButton = new JRadioButton();
    private final JPanel varTypePanel = new JPanel();
    private final JRadioButton NvstButton = new StyledRadioButton();
    private final PopulusParameterField paramn0 = new PopulusParameterField();
    private final GridBagLayout gridBagLayout11 = new GridBagLayout();
    private final PopulusParameterField paramrho = new PopulusParameterField();
    private final PopulusParameterField paramC = new PopulusParameterField();
    private final PopulusParameterField paramR0 = new PopulusParameterField();
    private final JPanel resourcePanel = new JPanel();
    private final GridBagLayout gridBagLayout12 = new GridBagLayout();
    private final JRadioButton seasonalModelButton = new JRadioButton();
    private final JPanel modelTypePanel = new JPanel();
    private final JRadioButton equableModelButton = new JRadioButton();
