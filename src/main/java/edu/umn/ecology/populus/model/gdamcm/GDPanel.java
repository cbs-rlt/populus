...
public class GDPanel extends BasicPlotInputPanel {
    ...
    final JRadioButton singleFrequencyButton = new JRadioButton();
    final JCheckBox selfingBox = new JCheckBox();
    final JRadioButton otherButton = new JRadioButton();
    TitledBorder titledBorder2;
    Border border3;
    final JPanel initialConditionsPanel = new JPanel();
    TitledBorder titledBorder3;
    final GridBagLayout gridBagLayout2 = new GridBagLayout();
    final JPanel breedingPanel = new JPanel();
    final PopulusParameterField[] lociFrequencies = new PopulusParameterField[MAX_LOCI];
    final GridBagLayout gridBagLayout1 = new GridBagLayout();
    final JCheckBox viewGens3DCB = new JCheckBox();
    final JTabbedPane switcherTP = new JTabbedPane();
    final PopulusParameterField paramNumLoci = new PopulusParameterField();
    final JPanel montecarloP = new JPanel();
    final JPanel singleFreqPanel = new JPanel();
    final JPanel markovP = new JPanel();
    final ResourceBundle res = ResourceBundle.getBundle("edu.umn.ecology.populus.model.gdamcm.Res");
    final PopulusParameterField paramGens = new PopulusParameterField();
    final GridBagLayout gridBagLayout3 = new GridBagLayout();
    final JPanel runtimePanel = new JPanel();
    final JPanel scrollPaneInside = new JPanel();
    final SimpleVFlowLayout simpleVFlowLayout1 = new SimpleVFlowLayout();
    final JScrollPane jScrollPane1 = new JScrollPane();
    final PopulusParameterField paramN = new PopulusParameterField();
    final SimpleVFlowLayout simpleVFlowLayout5 = new SimpleVFlowLayout();
    final PopulusParameterField numAGenesPPF = new PopulusParameterField();
    final SimpleVFlowLayout simpleVFlowLayout4 = new SimpleVFlowLayout();
    final PopulusParameterField popSizePPF = new PopulusParameterField();
    final JPanel individualFreqPanel = new JPanel();
    final PopulusParameterField paramInitFreq = new PopulusParameterField();
    final PopulusParameterField gensToViewPPF = new PopulusParameterField();
    final SimpleVFlowLayout simpleVFlowLayout3 = new SimpleVFlowLayout();
    final GridBagLayout gridBagLayout5 = new GridBagLayout();
    final JRadioButton individualFrequencyButton = new JRadioButton();
    final StyledRadioButton gensButton = new StyledRadioButton();
    final ButtonGroup goBG = new ButtonGroup();
    final ButtonGroup siBG = new ButtonGroup();
    ...
    private void jbInit() throws Exception {
        ...
        myBar.addAdjustmentListener(e -> jScrollPane1.getViewport().repaint());
    ...
    class IncrementChecker implements ParameterFieldListener {
        ...
        public void parameterFieldChanged(ParameterFieldEvent e) {
            ...
            paramInitFreq.setCurrentValue(increment * (Math.round(paramInitFreq.getDouble() / increment)));
            for (PopulusParameterField lociFrequency : lociFrequencies) {
                lociFrequency.setIncrement(increment);
                lociFrequency.setCurrentValue(increment * (Math.round(lociFrequency.getDouble() / increment)));
            }
        }
    }
