...
public class EOVPanel extends BasicPlotInputPanel {
    ...
    final PopulusParameterField paramI = new PopulusParameterField();
    ...
    private final PopulusParameterField paramBirth1 = new PopulusParameterField();
    private final PopulusParameterField paramDeath = new PopulusParameterField();
    private final PopulusParameterField paramBirth0 = new PopulusParameterField();
    private final PopulusParameterField paramP = new PopulusParameterField();
    private final JRadioButton ebvstButton = new StyledRadioButton();
    private final JRadioButton HIStarButton = new StyledRadioButton();
    private final JRadioButton hivstButton = new StyledRadioButton();
    private final JPanel constantsPanel1 = new JPanel();
    private final PopulusParameterField paramC3 = new PopulusParameterField();
    ...
    private final JRadioButton coupledModelButton = new JRadioButton();
    private final JRadioButton alternatingModelButton = new JRadioButton();
