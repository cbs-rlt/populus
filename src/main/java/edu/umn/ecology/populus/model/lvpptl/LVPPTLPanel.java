...
public class LVPPTLPanel extends BasicPlotInputPanel {
    ...
    final JPanel predatorPanel = new JPanel();
    final JPanel graphTypePanel = new JPanel();
    final PopulusParameterField paramPreyK = new PopulusParameterField();
    final JRadioButton buttonPvN = new StyledRadioButton();
    final PopulusParameterField paramR = new PopulusParameterField();
    final JRadioButton buttonPNvT = new StyledRadioButton();
    final JPanel predatorGrowthPanel = new JPanel();
    final GridLayout gridLayout1 = new GridLayout();
    final PopulusParameterField paramD = new PopulusParameterField();
    Border border1;
    final PopulusParameterField paramTLN0 = new PopulusParameterField();
    TitledBorder titledBorder1;
    final PopulusParameterField paramh = new PopulusParameterField();
    final JPanel lotkaVolterraParams = new JPanel();
    final GridBagLayout gridBagLayout3 = new GridBagLayout();
    final PopulusParameterField paramC2 = new PopulusParameterField();
    TitledBorder titledBorder9;
    final PopulusParameterField paramr2 = new PopulusParameterField();
    final GridLayout gridLayout7 = new GridLayout();
    final PopulusParameterField paramLVP0 = new PopulusParameterField();
    ...
    final PopulusParameterField paramC1 = new PopulusParameterField();
    final GridLayout gridLayout4 = new GridLayout();
    final PopulusParameterField paramr1 = new PopulusParameterField();
    Border border6;
    final PopulusParameterField paramLVN0 = new PopulusParameterField();
    ...
    final PopulusParameterField paramTLP0 = new PopulusParameterField();
    Border border4;
    final JPanel frParamsPanel = new JPanel();
    TitledBorder titledBorder4;
    final PopulusParameterField paramC = new PopulusParameterField();
    final JRadioButton thetaLogisticButton = new JRadioButton();
    TitledBorder titledBorder8;
    final JRadioButton lotkaVolterraButton = new JRadioButton();
    final JPanel preyPanel = new JPanel();
    Border border9;
    final JTabbedPane modelSpecificParamsTabbedPane = new JTabbedPane();
    Border border10;
    final JPanel thetaLogisticParams = new JPanel();
    final GridLayout gridLayout2 = new GridLayout();
    final GridBagLayout gridBagLayout1 = new GridBagLayout();
    final JComboBox<String> typeComboBox = new JComboBox<>();
    final GridBagLayout gridBagLayout5 = new GridBagLayout();
    final JPanel preyGrowthPanel = new JPanel();
    private final PopulusParameterField paramK = new PopulusParameterField();
    private final PopulusParameterField paramTh = new PopulusParameterField();
    private final PopulusParameterField paramA = new PopulusParameterField();
    private final JPanel lvParamsPanel = new JPanel();
    ...
    private final JCheckBox ddPreyBox = new JCheckBox();
    private final JCheckBox type2Box = new JCheckBox();
