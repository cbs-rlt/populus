...
public class DIGPanel extends BasicPlotInputPanel {
    ...
    final PopulusParameterField rPF3 = new PopulusParameterField();
    final SimpleVFlowLayout simpleVFlowLayout7 = new SimpleVFlowLayout();
    final PopulusParameterField n0PF2 = new PopulusParameterField();
    final JPanel graph3 = new JPanel();
    Box box17;
    Box box6;
    final GridBagLayout gridBagLayout7 = new GridBagLayout();
    final PopulusParameterField n0PF3 = new PopulusParameterField();
    final JPanel jPanel1 = new JPanel();
    final PopulusParameterField n0PF1 = new PopulusParameterField();
    final JCheckBox one = new JCheckBox();
    Box box4;
    final GridBagLayout gridBagLayout1 = new GridBagLayout();
    final PopulusParameterField lambdaPF2 = new PopulusParameterField();
    final GridBagLayout gridBagLayout6 = new GridBagLayout();
    final JPanel modelParametersPanel2 = new JPanel();
    final SimpleVFlowLayout simpleVFlowLayout5 = new SimpleVFlowLayout();
    DIGData[] myData;
    final PopulusParameterField rPF1 = new PopulusParameterField();
    final JPanel modelTypePanel = new JPanel();
    final PopulusParameterField lambdaPF = new PopulusParameterField();
    Border border1;
    final JPanel modelParametersPanel4 = new JPanel();
    ...
    final JRadioButton continuousButton = new JRadioButton();
    final SimpleVFlowLayout simpleVFlowLayout4 = new SimpleVFlowLayout();
    final JRadioButton discreteButton = new JRadioButton();
    final JPanel modelParametersPanel1 = new JPanel();
    final ButtonGroup bg = new ButtonGroup();
    final PopulusParameterField rPF2 = new PopulusParameterField();
    final ButtonGroup bgPlot = new ButtonGroup();
    Box box5;
    final JPanel plotTypePanel = new JPanel();
    final PopulusParameterField lambdaPF1 = new PopulusParameterField();
