...
public class TPPanel extends BasicPlotInputPanel {
    ...
    final PopulusParameterField paramE = new PopulusParameterField();
    ...
    final PopulusParameterField paramAlphas = new PopulusParameterField();
    final GridBagLayout gridBagLayout3 = new GridBagLayout();
    final PopulusParameterField paramL0 = new PopulusParameterField();
    final PopulusParameterField paramR0 = new PopulusParameterField();
    final JPanel populationPanel = new JPanel();
    final GridBagLayout gridBagLayout2 = new GridBagLayout();
    private final PopulusParameterField paramInduction = new PopulusParameterField();
    private final PopulusParameterField paramQ = new PopulusParameterField();
    private final PopulusParameterField paramRho = new PopulusParameterField();
    private final PopulusParameterField paramP = new PopulusParameterField();
    private final JRadioButton vstButton = new StyledRadioButton();
    private final JPanel phageratePanel = new JPanel();
    private final PopulusParameterField paramSigmat = new PopulusParameterField();
    private final GridBagLayout gridBagLayout6 = new GridBagLayout();
    private final PopulusParameterField paramSigmav = new PopulusParameterField();
    private final GridBagLayout gridBagLayout4 = new GridBagLayout();
    private final JRadioButton fiveButton = new JRadioButton();
    private final JRadioButton fourButton = new JRadioButton();
    private final JPanel modelTypePanel = new JPanel();
    final JRadioButton threeButton = new JRadioButton();
    final JRadioButton twoButton = new JRadioButton();
    final JRadioButton oneButton = new JRadioButton();
    final PopulusParameterField paramS0 = new PopulusParameterField();
    final JPanel phagePanel = new JPanel();
    final PopulusParameterField paramV0 = new PopulusParameterField();
    final PopulusParameterField paramT0 = new PopulusParameterField();
    final GridBagLayout gridBagLayout8 = new GridBagLayout();
    final PopulusParameterField paramBetat = new PopulusParameterField();
    final PopulusParameterField paramBetav = new PopulusParameterField();
    final PopulusParameterField paramTau = new PopulusParameterField();
    ...
    final PopulusParameterField paramAlphar = new PopulusParameterField();
    final PopulusParameterField paramResource = new PopulusParameterField();
    ...
    private void jbInit() throws Exception {
        ...
        vstButton.addActionListener(this::vstButton_actionPerformed);
