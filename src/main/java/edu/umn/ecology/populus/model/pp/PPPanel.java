...
public class PPPanel extends BasicPlotInputPanel {
    ...
    Border border1;
    final PopulusParameterField mPF = new PopulusParameterField();
    ...
    final JRadioButton xypvstButton = new StyledRadioButton();
    final PopulusParameterField alphaPF = new PopulusParameterField();
    TitledBorder titledBorder1;
    final PopulusParameterField aYPF = new PopulusParameterField();
    final SimpleVFlowLayout simpleVFlowLayout1 = new SimpleVFlowLayout();
    final GridBagLayout gridBagLayout2 = new GridBagLayout();
    Border border2;
    final PopulusParameterField gPPF = new PopulusParameterField();
    TitledBorder titledBorder2;
    final PopulusParameterField x0PF = new PopulusParameterField();
    Border border3;
    ...
    final PopulusParameterField y0PF = new PopulusParameterField();
    final JPanel plotTypePanel = new JPanel();
    final PopulusParameterField gPF = new PopulusParameterField();
    final JRadioButton vsButton = new StyledRadioButton();
    final PopulusParameterField lambdaPF = new PopulusParameterField();
    final PopulusParameterField betaPF = new PopulusParameterField();
    final JRadioButton randButton = new JRadioButton();
    final GridBagLayout gridBagLayout3 = new GridBagLayout();
    final JRadioButton switchButton = new JRadioButton();
    final PopulusParameterField sPF = new PopulusParameterField();
    final ButtonGroup bg = new ButtonGroup();
    final ButtonGroup vs = new ButtonGroup();
    final PopulusParameterField aXPF = new PopulusParameterField();
