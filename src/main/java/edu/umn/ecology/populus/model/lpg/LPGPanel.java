...
public class LPGPanel extends BasicPlotInputPanel {
    ...
    final JPanel parametersPanel3 = new JPanel();
    final PopulusParameterField paramN3 = new PopulusParameterField();
    final PopulusParameterField paramr2 = new PopulusParameterField();
    final StyledRadioButton nvstButton = new StyledRadioButton();
    final StyledRadioButton lnNtp1vslnNtButton = new StyledRadioButton();
    final SimpleVFlowLayout simpleVFlowLayout8 = new SimpleVFlowLayout();
    final JPanel plotTypePanel = new JPanel();
    final SimpleVFlowLayout simpleVFlowLayout4 = new SimpleVFlowLayout();
    final PopulusParameterField paramT2 = new PopulusParameterField();
    final JPanel graph2 = new JPanel();
    final PopulusParameterField paramK3 = new PopulusParameterField();
    final JPanel parametersPanel2 = new JPanel();
    final PopulusParameterField paramT3 = new PopulusParameterField();
    final JPanel leftPanel = new JPanel();
    final PopulusParameterField paramr3 = new PopulusParameterField();
    final PopulusParameterField paramK2 = new PopulusParameterField();
    final ResourceBundle res = ResourceBundle.getBundle("edu.umn.ecology.populus.model.lpg.Res");
    final StyledRadioButton dNdtButton = new StyledRadioButton();
    final JCheckBox two = new JCheckBox();
    final JTabbedPane graphs = new JTabbedPane();
    final JCheckBox four = new JCheckBox();
    final JPanel graph4 = new JPanel();
    final SimpleVFlowLayout simpleVFlowLayout6 = new SimpleVFlowLayout();
    final GridBagLayout gridBagLayout3 = new GridBagLayout();
    final PopulusParameterField paramN1 = new PopulusParameterField();
    LPGData[] myData;
    final PopulusParameterField paramT1 = new PopulusParameterField();
    ...
    final JRadioButton discrete = new JRadioButton();
    final SimpleVFlowLayout simpleVFlowLayout3 = new SimpleVFlowLayout();
    final JRadioButton laggedContinuous = new JRadioButton();
    final JPanel rightPanel = new JPanel();
    final JRadioButton continuous = new JRadioButton();
    ...
    final StyledRadioButton lnnvstButton = new StyledRadioButton();
    final SimpleVFlowLayout simpleVFlowLayout1 = new SimpleVFlowLayout();
    final StyledRadioButton dNNdtButton = new StyledRadioButton();
    final PopulusParameterField paramT = new PopulusParameterField();
    final ButtonGroup bgPlotType = new ButtonGroup();
    final PopulusParameterField paramr = new PopulusParameterField();
    final JPanel graph1 = new JPanel();
    final PopulusParameterField paramK = new PopulusParameterField();
    final JPanel graph3 = new JPanel();
    final PopulusParameterField paramN0 = new PopulusParameterField();
    final JCheckBox one = new JCheckBox();
    Border border1;
    final JCheckBox three = new JCheckBox();
    ...
    final JPanel parametersPanel1 = new JPanel();
    Border border2;
    ...
    final PopulusParameterField paramN2 = new PopulusParameterField();
    final PopulusParameterField paramTime = new PopulusParameterField();
    final SimpleVFlowLayout simpleVFlowLayout7 = new SimpleVFlowLayout();
    Border border3;
    Border border4;
