...
public class ASPGParamInfo implements BasicPlot, TableInterface {
    ...
    public BasicPlotInfo getBasicPlotInfo() {
        ...
        switch (outputType) {
            case ASPGPanel.kLESLIEMATRIX, ASPGPanel.kTABULAROUTPUT -> returnValue = new BasicPlotInfo(this);
            ...
            case ASPGPanel.kVXVSX -> {
                ...
                for (int i = 0; i < numClasses; i++) {
                    ...
                    for (int xi = i; xi < numClasses; xi++) {
                        va += Math.exp(-r * (xi)) * lxmxTable[kL][xi] * lxmxTable[kM][xi];
                    }
...
//3d
            ...
            default -> System.err.println(res.getString("Unknown_model_type"));
        }
