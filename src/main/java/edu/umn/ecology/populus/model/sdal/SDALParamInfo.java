...
public class SDALParamInfo implements BasicPlot {
    ...
    private final int coeffType;
    private double min, max;
    private final int freqNumber;
    ...
    private final String yCap3 = ColorScheme.getColorString(0) + " <b><i>w\u0305</> ";
    private final String pCap = " Allelic Frequency (  " + ColorScheme.getColorString(0) + "<i><b>p</> )  ";
    private static final String xpCap = " Allelic Frequency ( <i><b>p</> )  ";
    private final String yCap4 = ColorScheme.getColorString(0) + "p<sup>2</>,   " + ColorScheme.getColorString(1) + "2pq</>,   " + ColorScheme.getColorString(2) + "q<sup>2</>";
    private static final String xCap1 = res.getString("Generations_b_i_t_");
    private final String yCap2 = ColorScheme.getColorString(0) + " <b><i>\u0394p</> ";
