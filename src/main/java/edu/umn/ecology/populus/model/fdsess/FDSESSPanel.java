...
public class FDSESSPanel extends BasicPlotInputPanel {
    ...
    private void jbInit() throws Exception {
        ...
        RDRB.setText("D");
        RDRB.addChangeListener(this::RDRB_stateChanged);
        RCRB.setText("C");
        RCRB.addChangeListener(this::RCRB_stateChanged);
        RBRB.setSelected(true);
        RBRB.setText("B");
        RBRB.addChangeListener(this::RBRB_stateChanged);
        RARB.setEnabled(false);
        RARB.setText("A");
        RARB.addChangeListener(this::RARB_stateChanged);
        IDRB.setText("D");
        IDRB.addChangeListener(this::IDRB_stateChanged);
        ICRB.setText("C");
        ICRB.addChangeListener(this::ICRB_stateChanged);
        IBRB.setEnabled(false);
        IBRB.setText("B");
        IBRB.addChangeListener(this::IBRB_stateChanged);
        IARB.setSelected(true);
        IARB.setText("A");
        IARB.addChangeListener(this::IARB_stateChanged);
