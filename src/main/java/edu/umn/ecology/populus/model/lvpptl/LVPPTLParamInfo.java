...
public class LVPPTLParamInfo implements BasicPlot {
    ...
    private final String xCap = res.getString("Time_b_i_t_");
    private final String yCap = res.getString("Population_") + ColorScheme.getColorString(0) + "<b><i>P </i></b></FONT>, " + ColorScheme.getColorString(1) + "<i><b>N </></FONT> )";
    private final String n1Cap = res.getString("PPopulation_b_i_") + ColorScheme.getColorString(0) + "P</> )";
    private String mCapNvsT, mCapN2vsN1;
    private final String n2Cap = res.getString("NPopulation_b_i_") + ColorScheme.getColorString(1) + "N</> )";
