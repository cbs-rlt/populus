...
public class SDPanel extends ModelPanel {
    ...
    winnerPPF.addParameterFieldListener(new edu.umn.ecology.populus.visual.ppfield.ParameterFieldListener() {
		...
		gameBG.add(hdRB);
		gameBG.add(pdRB);
		gametypeP.setLayout(verticalFlowLayout2);
		...
		outputP.setLayout(verticalFlowLayout3);
		...
		initBG.add(onecRB);
		initBG.add(randomRB);
		layoutP.setLayout(verticalFlowLayout4);
		...
		pdparamP.setLayout(verticalFlowLayout5);
