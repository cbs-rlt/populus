...
JPanel modParamP = new JPanel();
   ...
   private void jbInit() throws Exception {
      ...
      bPPF.addParameterFieldListener(new edu.umn.ecology.populus.visual.ppfield.ParameterFieldListener() {
         public void parameterFieldChanged(ParameterFieldEvent e) {
            bPPF_parameterFieldChanged(e);
         }
      });
      ...
      ePPF.addParameterFieldListener(new edu.umn.ecology.populus.visual.ppfield.ParameterFieldListener() {
         public void parameterFieldChanged(ParameterFieldEvent e) {
            ePPF_parameterFieldChanged(e);
         }
      });
      ...
      aPPF.addParameterFieldListener(new edu.umn.ecology.populus.visual.ppfield.ParameterFieldListener() {
         public void parameterFieldChanged(ParameterFieldEvent e) {
            aPPF_parameterFieldChanged(e);
         }
      });
      ...
      andersonRB.addChangeListener(new javax.swing.event.ChangeListener() {
         public void stateChanged(ChangeEvent e) {
            andersonRB_stateChanged(e);
         }
      });
