...
ResourceBundle res = ResourceBundle.getBundle( "edu.umn.ecology.populus.model.ihpi.Res" );
   ...
   */
   ...
   private void jbInit() throws Exception {
      ...
      type3Button.addChangeListener( new javax.swing.event.ChangeListener()  {

         public void stateChanged( ChangeEvent e ) {
            type3Button_stateChanged( e );
         }
      } );
      ...
      type1Button.addChangeListener( new javax.swing.event.ChangeListener()  {

         public void stateChanged( ChangeEvent e ) {
            type1Button_stateChanged( e );
         }
      } );
      ...
      type2Button.addChangeListener( new javax.swing.event.ChangeListener()  {

         public void stateChanged( ChangeEvent e ) {
            type2Button_stateChanged( e );
         }
      } );
      ...
      type4Button.addChangeListener( new javax.swing.event.ChangeListener()  {

         public void stateChanged( ChangeEvent e ) {
            type4Button_stateChanged( e );
         }
      } );
