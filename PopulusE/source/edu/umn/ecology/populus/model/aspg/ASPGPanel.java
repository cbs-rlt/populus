...
public class ASPGPanel extends BasicPlotInputPanel implements java.io.Externalizable {
   ...
   private void jbInit() throws Exception {
      ...
      projectionScroller.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
      projectionScroller.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
