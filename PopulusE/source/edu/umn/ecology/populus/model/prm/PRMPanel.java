...
static ResourceBundle res = ResourceBundle.getBundle( "edu.umn.ecology.populus.model.prm.Res" );
   ...
   private void jbInit() throws Exception {
    ...
    "to the treatment");
      ...
      CominsButton.addActionListener( new java.awt.event.ActionListener()  {

         public void actionPerformed( ActionEvent e ) {
            CominsButton_actionPerformed( e );
         }
      } );
      AlstadAndowButton.setText("Alstad & Andow <i>Bt</i> maize model" );
      AlstadAndowButton.setFocusPainted( false );
      AlstadAndowButton.addActionListener( new java.awt.event.ActionListener()  {

         public void actionPerformed( ActionEvent e ) {
            AlstadAndowButton_actionPerformed( e );
         }
      } );
    ...
    "times as large as treated)");
      ...
      threevstButton.addActionListener(new java.awt.event.ActionListener() {
         public void actionPerformed(ActionEvent e) {
            threevstButton_actionPerformed(e);
         }
      });
      threevstButton.setText("<i>(x + y ) vs t</i>");
      fourvstButton.setActionCommand("<i>( x * p ) + ( y * w ) vs t</i>");
      fourvstButton.setFocusPainted(false);
      fourvstButton.addActionListener(new java.awt.event.ActionListener() {
         public void actionPerformed(ActionEvent e) {
            fourvstButton_actionPerformed(e);
         }
      });
    ...
    "larval mortality disappears");
     ...
     paramS3.setParameterName("<i>s<sub>3</sub></i>");
      ...
      twovstButton.addActionListener(new java.awt.event.ActionListener() {
         public void actionPerformed(ActionEvent e) {
            twovstButton_actionPerformed(e);
         }
      });
      ...
      onevstButton.addActionListener(new java.awt.event.ActionListener() {
         public void actionPerformed(ActionEvent e) {
            onevstButton_actionPerformed(e);
         }
      });
