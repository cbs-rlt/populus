...
/**
  These are for the options under the Options button.
  */

public class MenuOptions {
   public static final int kZoomIn        = 0;
   public static final int kZoomOut       = 1;
   public static final int kCoarserGrid   = 2;
   ...
   //public static final int kScale       = 64;//not sure if i'll need this one later...
