...
public abstract class Model extends Object implements ParameterFieldListener,ModelPanelListener,OutputPanelListener,Externalizable {
   ...
   static private int colorNumber = 0;
   ...
   */
   ...
   /**
     * Saves the Output graphics of the model in JPEG format. Modified from:
     * @author K Kal <k_kal@my-deja.com>
     */
