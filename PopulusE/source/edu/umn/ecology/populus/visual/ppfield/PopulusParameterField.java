...
public class PopulusParameterField extends JPanel implements Externalizable {
   ...
   public double getCurrentValue() { return getCurrentValue(false); }
   ...
   void aboutParameterMenuItem_actionPerformed( ActionEvent e ) {
      ...
      if( this.getHelpText() != null ) {
         ...
         ml = new MultiLabel( stringLines, null, 4, 0, JLabel.LEFT );
      }
      else {
         ml = new MultiLabel( new String[] {
            "*NO INFORMATION AVAILABLE*"
         }, null, 4, 0, JLabel.LEFT );
      }
   ...
   private void jbInit() throws Exception {
      ...
      arrowButtonSet.addActionListener( new ActionListener()  {
      ...
      setToDefaultMenuItem.addActionListener( new java.awt.event.ActionListener()  {

         public void actionPerformed( ActionEvent e ) {
            setToDefaultMenuItem_actionPerformed( e );
         }
      } );
      setToMinimumMenuItem.setText( "Set to Minimum" );
      setToMinimumMenuItem.addActionListener( new java.awt.event.ActionListener()  {

         public void actionPerformed( ActionEvent e ) {
            setToMinimumMenuItem_actionPerformed( e );
         }
      } );
      setToMaximumMenuItem.setText( "Set to Maximum" );
      setToMaximumMenuItem.addActionListener( new java.awt.event.ActionListener()  {

         public void actionPerformed( ActionEvent e ) {
            setToMaximumMenuItem_actionPerformed( e );
         }
      } );
      aboutParameterMenuItem.setText( "About Parameter" );
      aboutParameterMenuItem.addActionListener( new java.awt.event.ActionListener()  {

         public void actionPerformed( ActionEvent e ) {
            aboutParameterMenuItem_actionPerformed( e );
         }
      } );
      numberField.addKeyListener( new EnterListener() );
      this.setEnabled( true );
      this.setDoubleBuffered( false );
      setIncrementAmount.addActionListener( new java.awt.event.ActionListener()  {

         public void actionPerformed( ActionEvent e ) {
            setIncrementAmount_actionPerformed( e );
         }
      } );
