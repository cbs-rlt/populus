...
double[][] eigenvectors;
   double[] re, ie;
   String[] text;
   private JList<String> eigenValueList = new JList<String>();
   ...
   private void jbInit() throws Exception {
      ...
      eigenValueList.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
         public void valueChanged(ListSelectionEvent e) {
            eigenValueList_valueChanged(e);
         }
      });
