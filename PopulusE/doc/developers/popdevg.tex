...
The \verb ModelPanel  (input window) base files are in \verb edu.umn.ecology.populus.edwin  (short for editor window, from the DOS program's naming conventions).
